...
test_benchmark_serving_range() {
    ...
    log_name_prefix=benchmark_serving-sla_${model_path}_cardnumber_${local_tp_size}_datatype_${dtype}_in_${local_input}_out_${local_output}_ratio_${local_ratio}_rate_${local_request_rate}_prompts_${local_num_prompts}_random_concurrency_${local_max_concurrency}
